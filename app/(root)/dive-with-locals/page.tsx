...
const PACKAGES: DivePackage[] = [
  {
    ...
    locationLabel: "Fuvahmulah • Southern Maldives",
    shortLabel: "Tiger shark encounters",
    price: "From $1400 per person",
    duration: "6 nights • 7 days",
    blurb:
      "Stay on the wild, southern island of Fuvahmulah and dive with resident tiger sharks in their natural environment, alongside a mix of reef dives and local experiences.",
    inclusions: [
      "Return domestic air tickets Malé ↔ Fuvahmulah",
      "6 nights / 7 days in a beach-front hotel (shared standard rooms)",
      "Full-board meals every day (breakfast, lunch and dinner)",
      "5 dedicated tiger shark dives with local guides",
      "8 additional reef dives around Fuvahmulah",
      "Local dinner with Fuvahmulah families",
      "Guided island tour",
    ],
    addOns: [
      "Extra dive — approx. $70 per dive",
      "Full dive equipment — approx. $30 per day",
    ],
  },
  {
    id: "baa",
    title: "Dive in Baa Atoll – UNESCO Biosphere Reserve",
    locationLabel: "Baa Atoll • Dharavandhoo (UNESCO Biosphere Reserve)",
    shortLabel: "Reef & manta dives",
    price: "From $1400 per person",
    duration: "6 nights • 7 days",
    blurb:
      "Base yourself on Dharavandhoo and explore Baa Atoll’s thilas, reef walls and cleaning stations. In manta season, trips include boat runs to Hanifaru Bay.",
    inclusions: [
      "Return domestic air tickets Malé ↔ Dharavandhoo",
      "6 nights / 7 days in a beach-front guesthouse (shared standard rooms)",
      "Full-board meals every day (breakfast, lunch and dinner)",
      "10 guided boat dives around Baa Atoll",
      "2 Hanifaru Bay trips during manta season (when conditions allow)",
      "Local dinner with Dharavandhoo families",
      "Guided island walk and sandbank visit",
    ],
    addOns: [
      "Extra dive — approx. $70 per dive",
      "Full dive equipment — approx. $30 per day",
          ...
          <div className="space-y-5">
            <div className="inline-flex items-center gap-2 rounded-full bg-sky-100/90 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-sky-900 ring-1 ring-sky-200 shadow-sm">
              ...
              <span className="normal-case text-[11px] font-medium tracking-normal text-sky-800">
                Baa Atoll • Fuvahmulah • Small-group diving
              </span>
            </div>
